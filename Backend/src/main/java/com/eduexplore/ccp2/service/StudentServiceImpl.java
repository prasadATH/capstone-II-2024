...
public class StudentServiceImpl implements StudentService {
    ...
    public String sendOtp(String email,String username) {
        ...
        if(traveller != null && traveller2.getEmail().equals(email)){ //This means that the email is equal to the added usernames email so its the same person
    ...
    public String VerifyOtp(String otp, String username) {
        ...
        if(traveller != null && traveller.getOtp().equals(otp)){ //This means that the email is equal to the added usernames email so its the same person
