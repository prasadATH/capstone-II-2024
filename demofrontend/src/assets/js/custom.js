...
//signup form enable function
document.getElementById('signUpButton').addEventListener('click', function() {
    const modal = document.getElementById('loginModal-signup');
    modal.style.display = 'flex';
    setTimeout(() => {
        modal.classList.add('show');
        document.body.classList.add('modal-active');
    }, 10); // Slight delay to ensure display change is applied before transition
});
...
//login form enable function


document.getElementById('loginButton').addEventListener('click', function() {
	const lgnmodal = document.getElementById('loginModal-signup');
    lgnmodal.classList.remove('show');
    document.body.classList.remove('modal-active');
   
	lgnmodal.style.display = 'none';

    const modal = document.getElementById('loginModal-login');
    modal.style.display = 'flex';
    setTimeout(() => {
        modal.classList.add('show');
        document.body.classList.add('modal-active');
